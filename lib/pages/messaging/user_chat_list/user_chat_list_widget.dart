...
import 'user_chat_list_model.dart';
export 'user_chat_list_model.dart';

class UserChatListWidget extends StatefulWidget {
  const UserChatListWidget({super.key});
...
class _UserChatListWidgetState extends State<UserChatListWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserChatListModel());
          ...
          child: Row(
            ...
            children: [
              ...
              Card(
                ...
                color: FlutterFlowTheme.of(context).rushdGreen6,
                elevation: 1.0,
