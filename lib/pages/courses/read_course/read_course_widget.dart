...
import 'read_course_model.dart';
export 'read_course_model.dart';

class ReadCourseWidget extends StatefulWidget {
  const ReadCourseWidget({super.key});

  @override
  State<ReadCourseWidget> createState() => _ReadCourseWidgetState();
}

class _ReadCourseWidgetState extends State<ReadCourseWidget>
    with TickerProviderStateMixin {
  late ReadCourseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadCourseModel());
