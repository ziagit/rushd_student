...
import 'read_subject_model.dart';
export 'read_subject_model.dart';

class ReadSubjectWidget extends StatefulWidget {
  const ReadSubjectWidget({super.key});

  @override
  State<ReadSubjectWidget> createState() => _ReadSubjectWidgetState();
}

class _ReadSubjectWidgetState extends State<ReadSubjectWidget>
    with TickerProviderStateMixin {
  late ReadSubjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadSubjectModel());
